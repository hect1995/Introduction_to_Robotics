...
if("TRUE" STREQUAL "TRUE")
  set(motion_plan_SOURCE_PREFIX /home/wasp/catkin_ws/src/ras_lab1/motion_plan)
  set(motion_plan_DEVEL_PREFIX /home/wasp/catkin_ws/devel)
  ...
  set(motion_plan_INSTALL_PREFIX /home/wasp/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'wasp <hectorec@kth.se>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'motion_plan' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/wasp/catkin_ws/src/ras_lab1/motion_plan/${idir}'.  ${_report}")
    endif()
